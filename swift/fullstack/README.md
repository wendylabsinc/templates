...
One React page and a small swift backend. Requires a reachable WendyOS device,
...
Change `Hello from Wendy!` in `Sources/{{.APP_ID}}/App.swift`, then run `wendy run` again.
