...
This React frontend is built into the Swift fullstack application. The
production Dockerfile runs `npm run build`; Hummingbird serves the compiled
files and `/api/*` from the same origin.
