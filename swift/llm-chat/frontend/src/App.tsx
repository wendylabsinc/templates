...
const defaultSystemPrompt =
  "You are a concise, friendly assistant for Jetson Orin Nano. Keep answers practical. /no_think"
...
const starterMessages: ChatMessage[] = [
  {
    ...
    role: "assistant",
    content:
      "Ready when you are. Ask about Jetson workflows, CUDA tuning, or ideas to prototype with Qwen3 4B.",
...
const promptChips = [
  ...
  "Explain how GPU offload works in llama.cpp on Jetson.",
  "Draft a quick checklist for benchmarking Qwen3 4B.",
  "Give me three creative demo ideas for a robotics lab.",
]
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <h1 className="text-4xl font-semibold tracking-tight text-slate-900 [font-family:'Newsreader',serif]">
                Qwen3 4B, dressed for the edge.
              </h1>
              <p className="max-w-xl text-base text-slate-600">
                A full-stack Swift + shadcn chat surface for running GGUF models on Jetson
                Orin Nano with CUDA offload.
              </p>
            </div>
            ...
            <CardHeader className="border-b border-slate-200/70">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <CardDescription>
                    Responses are generated by llama-cli on the server.
                  </CardDescription>
                </div>
                {meta?.durationMs ? (
            ...
            <CardFooter className="flex flex-col gap-3 border-t border-slate-200/70">
              <div className="flex w-full flex-col gap-3 md:flex-row">
                <Textarea
                  ...
                  placeholder="Ask something about Jetson workflows, CUDA tuning, or tooling ideas..."
                ...
                <Button
                  onClick={sendMessage}
                  disabled={!canSend}
                  className="h-auto gap-2 rounded-2xl px-5"
                >
                  <Send className="h-4 w-4" />
                  Send
                </Button>
